...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://www.2xnz.qzz.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "1614911881", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/legspcpd/Mizuki",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1614911881",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/legspcpd/Mizuki",
					external: true,
					icon: "mdi:git",
				},
			],
